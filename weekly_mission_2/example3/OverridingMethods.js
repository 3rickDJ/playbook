...
class Viajero extends Explorer {
  constructor(name, username, mission, cycle){
    super(name, username, mission, cycle) // SUPER nos ayudará a llamar el constructor padre
...
const viajero2 = new Explorer('Erick', '3rickDJ', 'Node JS', 'Abril 2022')
console.log(viajero2)
console.log(viajero2.getNameAndUsername())

const viajero1 = new Viajero('Carlo', 'UltimateSherpa', 'Node JS', 'Abril 2022')
